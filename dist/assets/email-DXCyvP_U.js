import{C as S,o as g,O as h,E as c,M as _,R as s,S as f,a as C,j as D,l as b,z as d,m as u,n as $,L as W,q as P}from"./index-DJp7veNu.js";import{c as m,r as E}from"./index-DOAbPiwT.js";import{W as y}from"./index-DJAKu1mT.js";import"./index-COSB97vt.js";import"./index-C8XGm6Rm.js";import{e as N,n as T}from"./ref-C0TEj9Bq.js";import"./index-BHw0zF23.js";import"./index-BXYsrYzF.js";import"./index-DuYXOv9T.js";import"./if-defined-C9tsH0It.js";import"./index-GhH914QS.js";var j=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends y{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,r;try{if(this.authConnector){const n=S.state.activeChain,i=g.getConnections(n),o=(t=h.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await g.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((r=h.state.remoteFeatures)!=null&&r.emailCapture)return;if(h.state.siwx){_.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=j([m("w3m-email-verify-otp-view")],I);const F=D`
  wui-icon-box {
